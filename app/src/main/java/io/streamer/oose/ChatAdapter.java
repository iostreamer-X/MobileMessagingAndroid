...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtMessage.setTypeface(font);
        ...
        if(chatMessage.getMessage().length()<=100){
            ...
            try {
                ...
                byte[] charData = Base64.decode(chatMessage.getMessage());
                Bitmap bm = BitmapFactory.decodeByteArray(charData, 0, charData.length);
    ...
    private void setAlignment(ViewHolder holder, boolean isMe) {
        if (!isMe) {
            ...
            holder.content.setBackgroundResource(R.color.green);
